...
SoloLearn (2023) Vowel Counter: https://www.sololearn.com

"""

sentences = str(input()).lower()

print(sentences.count('a') + sentences.count('e') + sentences.count('i') + sentences.count('o') + sentences.count('u'))
