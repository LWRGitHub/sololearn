...
SoloLearn (2023) Neverland: https://www.sololearn.com

"""


my_age = int(input())
years_past = int(input())

print(f"My twin is {my_age+years_past} years old and they are {years_past} years older than me")
